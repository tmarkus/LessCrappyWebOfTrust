...
2) Load the plugin in Freenet
3) Go to http://FREENET_HOST:8888/SoneBridge/setup
4) Setup oAUTH by following the instructions on the setup page (basically get an OOB, enter it and press SUBMIT)
5) Go to http://FREENET_HOST:8888/Sonebridge/manage to manage mapping a Twitter search request to a Sone ID
